...
Read Chapters 10 and 11 of Regression and Other Stories by Gelman, Hill, and Vehtari (free PDF available on the book's [website](https://avehtari.github.io/ROS-Examples/index.html))
"""

# ╔═╡ 31080b4a-db7d-4592-ad42-d664831254fa
md"We will work with the 'Kid IQ' dataset."
...
# ╔═╡ f0db37d3-1113-4068-a57f-0caccdbd4b85
md"""
## Maximum Likelihood Estimate
"""

# ╔═╡ e949fcec-c4db-4509-a09b-58b9afa90115
md"""
### Task 1 (15 Points)

Create a plot like Figure 11.1 showing the data and regression line.
You can use the `GLM.jl` package to estimate a maximum likelihood fit -- this means you will not show uncertainty in the resulting line (that's OK).
"""

# ╔═╡ 000ffb83-3f4d-48c8-89a6-3b6a62766016
plot()

# ╔═╡ 5d262be6-7b20-4308-b2d6-1801fd3209ba
md"""
### Task 2 (15 Points)

Similarly, reproduce figure 11.2. You can use the model you created in Task 1 and you may again neglect uncertainty in your fit.

> You can create side by side plots as shown below (you may want to use the `jitter` function defined below. I also recommend taking advantage of `alpha=0.5` or similar. The `markersize` argument may be helpful in your scatter plot too.)
"""
...
Now implement this model using Turing.
You don't have to worry about your priors yet (you'll come back to this).
Use `optimize(model, MLE())` to identify the maximum likelihood fit for your model.
Does it approximately match what you got with `GLM.jl`?
"""

# ╔═╡ ad45f7ae-ae55-4f80-b69a-0fb05ce6ca4b
md"""
## Bayesian Fit

Now we're ready to consider uncertainty a bit more carefully.

### Task 4 (20 Points)

Now fit this linear regression model using Turing.
You should:

1. rescale the data
1. apply priors
1. explain why you chose the priors you chose
1. sample from the posterior
1. create Monte Carlo predictions from the posterior
1. create point predictions from the posterior

You are welcome (strongly encouraged) to use the code from the regression notebook (to be crystal clear, it's not plagiarism to use it verbatim).
"""

# ╔═╡ 4577c340-7916-4e5f-8ec1-43928faaeadd
md"""
### Task 5 (15 Points)

Now that you have uncertain samples from the posterior, revisit Figure 11.1.
Add lines showing samples from the posterior (you can add 500 thin gray lines like Gelman et al, or you can graph the upper and lower bounds like the Regression notebook).
"""

# ╔═╡ 46a62a6f-7574-4554-9cf1-5cf080972061
md"""
### Task 6 (10 Points)

Now that you have point predictions from the posterior, create a plot emulating Figure 11.6.
In other words, residuals should be on the $y$-axis and Mother IQ Score should be on the $x$-axis.
"""

# ╔═╡ 348fa0cd-e03f-4489-ae73-b9f866972fba
md"""
### Task 7 (10 Points)

Now that you have your residuals, create side by side plots of (a) residuals versus predicted and (b) residuals vs observed values.
Use your point predictions from the posterior.

Why are these figures different?
*Do not copy and paste the explanation from the textbook (use your own words!)*
"""

# ╔═╡ ac0dfa31-ffb9-41d4-9bca-fc4681a13051
md"""
## Appendix
"""
