...
1. Run Julia
    ...
    After installing, make sure that you can run Julia. On some systems, this means searching for the "Julia 1.6" program installed on your computer; in others, it means running the command julia in a terminal. Make sure that you can execute `1 + 1`:

    ```julia
    julia> 1 + 1
    2 # yay! that seems right
    ```
...
- How to use `let` blocks to create local variables
- How to 
