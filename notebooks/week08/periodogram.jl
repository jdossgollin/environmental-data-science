...
There have been good explanations written before, so I won't reproduce them here.

**Read**: 

* [this tutorial](https://online.stat.psu.edu/stat510/lesson/6/6.1) (accessible)
* Brockwell 4.2 (more technical)

Let's simulate some AR(2) data:
"""
...
md"""
Now we can plot it and fit the periodogram
"""
